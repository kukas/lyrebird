...
SliderToggle.prototype.setValue = function (value) {
    this.value = Math.round(value);
    this.fg.position.set(0, this.value * this._height);
}
...
SliderToggle.prototype.mouseUp = function (target, pointer) {
    ...
    var y = Math.round(this.value) * this._height;
    console.log(y)
